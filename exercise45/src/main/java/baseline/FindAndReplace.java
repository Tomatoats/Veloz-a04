...
public class FindAndReplace {
    public FindAndReplace(ArrayList<String> input) throws FileNotFoundException {
      ...
      java has a string function called replace so we're just gonna make the arraylist a string and use replace to switch out
        utilize for use
       */
    ...
    private void printToFile(ArrayList<String> replacedInput) throws FileNotFoundException {
        ...
        PrintStream out = new PrintStream(new FileOutputStream("exercise45_output.txt"));
        System.setOut(out);
